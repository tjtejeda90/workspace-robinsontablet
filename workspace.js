...
cprequire_test(["inline:com-chilipeppr-workspace-robinsonmfgtablet"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-robinsonmfgtablet", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-robinsonmfgtablet", // Make the id the same as the cpdefine id
        name: "Workspace / TinyG Tablet", // The descriptive name of your widget.
        desc: `The tablet workspace for Robinsnon Mfg.`,
        url: "http://raw.githubusercontent.com/tjtejeda90/workspace-robinsontablet/master/auto-generated-workspace.html", // The final URL of the working widget as a single HTML file with CSS and Javascript inlined. You can let runme.js auto fill this if you are using Cloud9.
        ...
        loadWidgets: function(callback) {
            ...
            chilipeppr.load(
                ...
                "http://raw.githubusercontent.com/tjtejeda90/widget-axes/master/auto-generated-widget.html", 
